...
-- ncremental live completion (note: this is now a default on master).
...
vim.cmd [[highlight IndentBlanklineIndent1 guigb=#1f1f1f gui=nocombine]]
...
-- setup auto complete with parenthesis
...
-- Setup Nvim Tree using defaults
